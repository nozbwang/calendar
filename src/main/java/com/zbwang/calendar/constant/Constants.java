...
public class Constants {
	...
	// time
	public static int VALID_VISIT_TIME = 4 * 24 * 60 * 60 * 1000;
	// Content-Type
	// pic
	...
	// 类型
	public static final String B_TYPE_VOICE = "0";
	...
	public static final String B_TYPE_COMMENT = "5";
	public static final String B_TYPE_GALARY = "6";
	// 基础参数类型
